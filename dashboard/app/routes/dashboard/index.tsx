    ...
    return (
        <div className="flex flex-col flex-wrap items-center justify-center space-y-20 px-5 xl:px-10 w-full h-[82%]">
            ...
            <div className="grid grid-cols-2 gap-20 py-10 px-8 w-full rounded-sm bg-[#F4F3F9]">
                <Link className="bg-[#0F1932] text-white py-8 xl:py-10 px-8 rounded-sm" to={"/dashboard/total-images/"}>
                ...
                <Link className="bg-[#B36F30] text-white py-8 xl:py-10 px-8 rounded-sm" to={"/dashboard/pending-images/"}>
                    <div className="flex flex-col flex-wrap gap-y-1">
            ...
            <div className="grid grid-cols-2 gap-20 py-10 px-8 w-full rounded-sm bg-[#F4F3F9]">
                <Link className="bg-[#1D8B4E] text-white py-8 xl:py-10 px-8 rounded-sm" to={"/dashboard/approved-images/"}>
                    <div className="flex flex-col flex-wrap gap-y-1">
                ...
                <Link className="bg-[#AA2F27] text-white py-8 xl:py-10 px-8 rounded-sm" to={"/dashboard/rejected-images/"}>
                    <div className="flex flex-col flex-wrap gap-y-1">
