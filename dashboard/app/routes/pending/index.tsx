...
import { useGetPendingImagesQuery } from "~/redux/features/images/pendingImagesApi";
...
export default function Images() {
    ...
    const { data, isLoading, isError, isSuccess } = useGetPendingImagesQuery(undefined, { refetchOnMountOrArgChange: true });
    ...
    return (
        <div className="flex flex-col flex-wrap px-10 pb-3.5 h-[82%] relative">
            <div className="flex flex-row flex-wrap items-center justify-between h-[7%]">
                <h4 className="text-base font-medium">Pending images : {count}</h4>
            </div>
