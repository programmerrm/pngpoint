...
export default function ImageGrid({ images, onImageClick }: Props) {
    ...
    return (
        <div className="flex flex-col w-full overflow-hidden h-[590px]">
            {images.length > 0 && (
                <div className={`grid ${sideBar ? "grid-cols-3 xl:grid-cols-5" : "grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6"} gap-5 py-2.5 px-2.5 overflow-y-scroll overflow-x-hidden scrollbar-width`}>
