        ...
        <section className="relative top-0 left-0 right-0 py-5 w-full bg-[#FBFAFF]">
            <div className="max-w-screen-2xl container mx-auto px-2.5 lg:px-5 w-full">
                <div className="flex flex-col flex-wrap gap-y-5 w-full">
                    ...
                    {!isError && isLoading ? (
                        <div className="flex justify-center items-center h-[calc(100vh-300px)] w-full">
                        ...
                        <>
                            ...
                            <div className="flex flex-col flex-wrap items-center justify-center md:py-2.5 w-1/2 mx-auto">
                                <Pagination totalPages={Math.ceil(data.count / 300)} />
                            </div>
                        </>
                    ) : (
                        <div className="flex justify-center items-center h-[calc(100vh-280px)] w-full">
                            <p className="text-2xl text-gray-600 font-medium">No images found.</p>
                        </div>
                    )}
                </div>
            </div>
